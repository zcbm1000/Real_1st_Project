...
from utils.fire_Json_manager import load_fire_logs, save_fire_logs, get_next_log_id
...
ESP32_STREAM1_URL = "http://192.168.137.239:81/stream"
ESP32_STREAM2_URL = "http://192.168.137.64:81/stream"
